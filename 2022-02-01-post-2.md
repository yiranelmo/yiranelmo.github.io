...
This will be the home page of our webapp, which contains our webapp name and two expansion directions: 1. submit messages, 2. view messages and an introduction message
...
The extension page of `base.html` is `submit.html`. The page will display two submit boxes and a submit button. The two submission boxes are 1. Your message, 2. Your name or handle.
...
The function has three parts: 1. Connect the database, 2. Create a database for the messages, 3. Close the database.
