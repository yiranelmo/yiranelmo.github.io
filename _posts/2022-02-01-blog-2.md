...
For this change, I created a file called `style.css` and kept it in the `static` file. Please visit this [link](https://github.com/yiranelmo/webapp) for detailed code.
